    ...
    public function allCategory()
    {
        try {
            $featured = [
                ...
                'icon'                =>'mdi mdi-crowd',
                'banner'              => settingHelper('featured_category_banner') ? getFileLink('240x100',settingHelper('featured_category_banner')['images']) : get_media(@$this->thumbnail['image_130x93'], @$this->thumbnail['storage']),
