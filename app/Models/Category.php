...
class Category extends Model
{
    ...
    {
        return @is_file_exists($this->logo['image_130x95'], @$this->logo['storage']) ? get_media(@$this->logo['image_130x95'], @$this->logo['storage']) : get_media(@$this->thumbnail['image_130x93'], @$this->thumbnail['storage']);
    }
    ...
    {
        return @is_file_exists($this->logo['image_80x60'], @$this->logo['storage']) ? get_media(@$this->logo['image_80x60'], @$this->logo['storage']) : get_media(@$this->thumbnail['image_130x93'], @$this->thumbnail['storage']);
    }
    public function getPopularBannerAttribute()
    {
        return @is_file_exists($this->banner['image_835x200'], @$this->banner['storage']) ? get_media(@$this->banner['image_835x200'], @$this->banner['storage']) : get_media(@$this->thumbnail['image_130x93'], @$this->thumbnail['storage']);
    }
