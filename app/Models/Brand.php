...
class Brand extends Model
{
    ...
    {
        return is_file_exists(@$this->logo['image_130x93'], @$this->logo['storage']) ? get_media(@$this->logo['image_130x93'], @$this->logo['storage']) : get_media(@$this->thumbnail['image_130x93'], @$this->thumbnail['storage']);
    }
