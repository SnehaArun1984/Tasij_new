...
class Product extends Model
{
    ...
    {
        return @is_file_exists($this->thumbnail['image_190x230'] , $this->thumbnail['storage']) ? @get_media($this->thumbnail['image_190x230'],$this->thumbnail['storage']) : get_media(@$this->thumbnail['image_130x93'], @$this->thumbnail['storage']);
    }
    ...
    {
        return @is_file_exists($this->thumbnail['image_110x122'] , $this->thumbnail['storage']) ? @get_media($this->thumbnail['image_110x122'],$this->thumbnail['storage']) : get_media(@$this->thumbnail['image_130x93'], @$this->thumbnail['storage']);
    }
