...
class ProductStock extends Model
{
    ...
    {
        return @is_file_exists($this->image['image_190x230'] , $this->image['storage']) ? @get_media($this->image['image_190x230'],$this->image['storage']) : get_media(@$this->thumbnail['image_130x93'], @$this->thumbnail['storage']);
    }
