                        ...
                        <div>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>On</td>
                                    <td class="text-center">
                                        <i class="status fa {{ class_exists('ZipArchive') ? 'fa-check-circle-o' : 'fa-times-circle-o' }}"></i>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{old('purchase_code') ?? ''}}" id="purchase_code"
                                               ...
                                               placeholder="Find in codecanyon item download section"/>
