            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="mini-stats-wid card">
                        <div class="card-body">
                        <a href="http://localhost/tasij/admin/orders" aria-current="page" class="router-link-exact-active router-link-active">
                            <div class="wave"></div>
                            <div class="wave"></div>
                            <div class="d-flex">
                        ...
                        <a href="http://localhost/tasij/admin/orders" aria-current="page" class="router-link-exact-active router-link-active">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    ...
                                    <h6 class="mb-0">{{ get_price($total_sale,user_curr()) }}</h6>
                                </div>
                                <div class="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                                    <span class="avatar-title">
                ...
                <div class="col-md-3">
                    <div class="mini-stats-wid card">
                        <div class="card-body">
                        <a href="http://localhost/tasij/admin/products" aria-current="page" class="router-link-exact-active router-link-active">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                ...
                <div class="col-md-3">
                    <div class="mini-stats-wid card">
                        <div class="card-body">
                        <a href="http://localhost/tasij/admin/customers" aria-current="page" class="router-link-exact-active router-link-active">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                ...
                <div class="col-md-3">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="mini-stats-wid card">
                                <div class="card-body">
                                <a href="http://localhost/tasij/admin/brands" aria-current="page" class="router-link-exact-active router-link-active">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                        ...
                        @else
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="mini-stats-wid card">
                                    <div class="card-body">
                                    <a href="http://localhost/tasij/admin/categories" aria-current="page" class="router-link-exact-active router-link-active">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
