<template>
	<div>
		<ul class="products" :class="grid_class" v-if="products && products.length > 0">
			<li v-if="products[0] != 'id'" v-for="(product, index) in products" :key="index">
				<div class="sg-product" :class="{ 'style-1': type == 'flash' }">
					...
					<div class="product-info">
						...
						<div>
							<div data-v-e4caeaf8="" class="product_cart-btn"><a data-v-e4caeaf8="" href="javaScript:void(0)" class="custom-btn-outline"><span data-v-e4caeaf8="" class="mdi mdi-name mdi-shopping-outline"></span> <span data-v-e4caeaf8="" class="btn_text">Add To Cart</span></a></div>
							</div>
