                  ...
                  <span class="mdi mdi-name mdi-bank"></span> Affiliate Program
					...
					<div class="right-content new-list">
						<ul class="global-list">
							<li>
								<div class="location" style="background-color: #f5f5f5; text-align: center;"><div class="dropdown"><button class="dropbtn"><span class="mdi mdi-name mdi-map-marker-outline"></span> Deliver to Sneha Arun, Trivandrum 695583</button> <div class="dropdown-content"><a href="#"><span class="mdi mdi-name mdi-map-marker-outline"></span> Manu George, Kollam 695593</a> <a href="#"><span class="mdi mdi-name mdi-map-marker-outline"></span> Arathi James, Kazhakootam 695588</a> <a href="#"><span class="mdi mdi-name mdi-map-marker-outline"></span> Parvathy s, Trivandrum 695553</a></div></div></div>
							</li>
							<li>
		...
		<div :class="addons.includes('ishopet') ? toggleNavClass() : ''" id="middle_nav" class="header-middle">
			<div class="container">
				<div class="botom-content">
					<div class="sg-logo"><div class="sg-categorie-menu categorie-lg align-self-lg-center"><!----> <!----></div> <a href="http://localhost/tasij/" aria-current="page" class="router-link-exact-active router-link-active"><img src="https://tasij.lifeashorecrm.com/public/images/default/dark-logo.png" alt="Logo" class="img-fluid"></a></div>
    ...
    <div class="header-menu" :class="[toggleNavClass(), settings.header_theme]" id="nav" v-if="!addons.includes('ishopet')">
      <div class="container">
		...
		<div class="sg-categorie-menu home-menu-sm">
			<div class="sg-toggle" @click="$store.commit('setSmCategory', false)"><span class="mdi mdi-name mdi-close"></span></div>
