					...
					<div class="col-sm-6 col-md-6" :class="[classObj()]">
						<div class="footer-widget widget-border">
							...
							<ul class="global-list"
								...
								<li><a target="_blank" :href="getUrl('admin/dashboard')">{{ lang.dashboard }}</a></li>
								<li><a target="_blank" :href="getUrl('admin/profile')">{{ lang.my_profile }}</a></li>
								<li><a target="_blank" :href="getUrl('admin/password-change')">{{ lang.change_password
								}}</a></li>

							</ul>
							<ul class="global-list" v-else-if="authUser && authUser.user_type == 'seller'">
								<li><a target="_blank" :href="getUrl('seller/dashboard')">{{ lang.dashboard }}</a></li>
								<li><a target="_blank" :href="getUrl('seller/profile')">{{ lang.my_profile }}</a></li>
								<li><a target="_blank" :href="getUrl('seller/password-change')">{{ lang.change_password
								}}</a></li>
							</ul>
							<div class="footer-logo">
								<router-link :to="{ name: 'home' }"><img loading="lazy" :src="settings.footer_logo"
										alt="preloader" class="img-fluid" style="margin-top: 20px;"/> </router-link>
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-md-6" :class="[classObj()]">
							...
							<div class="address">
								<ul class="global-list">
									...
									<li>
										...
										<a :href="'tel:' + settings.footer_contact_phone">{{ settings.footer_contact_phone
										}}</a>
									</li>
								</ul>
							</div>
					...
					<div class="payment-card">
						<ul class="global-list">
							...
							<li v-if="settings.after_pay_banner"><img
									...
									class="img-fluid footer-payment-icon" /></li>
							<li v-if="settings.payment_method_banner" class="full-payment-img"><img
									:src="settings.payment_method_banner" alt="payment_method_banner"
									class="img-fluid footer-payment-icon" /></li>
						</ul>
					</div>
				</div>
