				...
				<div class="row justify-content-md-center">
					<div :class="{ 'col-lg-8 col-md-8': $route.name == 'product.details', 'col-lg-12': $route.name != 'product.details' }">
						<div class="product-details-2">
                           ...
                           :disabled="attributes.length == 0 && checkDisable(0,color)"/>
										<label :for="'color' + color.id" :class="{ 'disabled_radio' : attributes.length == 0 && checkDisable(0,color) }">
						...
						<div role="tabpanel" class="tab-pane fade" :class="{ 'show active': activeNav == 'delivery' }" id="delivery">
                          ...
                          <img class="img-fluid" v-if="review.user.profile_image" loading="lazy" :src="review.user.profile_image" :alt="review.user.full_name"/>
							...
							<div v-if="(authUser && !productDetails.user_review) || edit" class="review-form">
								...
								<div class="sg-rating">
									<div class="rating">
										<star-rating v-model:rating="product_form.rating" :star-size="20" active-color="#C9151B"></star-rating>
									</div>
								</div>
